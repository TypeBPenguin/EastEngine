...
public:
	struct InOutSlot
	{
		...
		eastengine::math::float2 f2Pos;
		eastengine::math::float2 f2Size;

		eastengine::math::float2 f2LinkerPos;

		eastengine::math::float2 f2ButtonSize;

		InOutSlot() {}
		InOutSlot(MaterialNodeManager* pManager, Type emType, int nNodeID, int nSlotIdx, const char* strLabel, const eastengine::math::float2& f2ButtonSize, ValueType emValueType = ValueType::eFloat)
			: pManager(pManager)
			, nNodeID(nNodeID)
			, emType(emType)
			, nSlotIdx(nSlotIdx)
		...
		const eastengine::math::float2& GetLinkerPos() const { return f2LinkerPos; }
		const eastengine::math::float2& GetPos() const { return f2Pos; }
		const eastengine::math::float2& GetSize() const { return f2Size; }

		void Render(ImDrawList* pDrawList, const eastengine::math::float2& f2Offset);
		void RenderBackground(ImDrawList* pDrawList, const eastengine::math::float2& f2Offset);
	};
...
public:
	MaterialNode(MaterialNodeManager* pManager, int nID, const char* name, const eastengine::math::float2& pos)
		: m_pManager(pManager)
		, m_nID(nID)
		, m_strName(name)
		, m_f2Pos(pos)
	...
	virtual void RenderNode(ImDrawList* pDrawList, const eastengine::math::float2& f2Offset);
	virtual void RenderNodeBackground(ImDrawList* pDrawList, const eastengine::math::float2& f2Offset);
	virtual void Update(ImDrawList* pDrawList, const eastengine::math::float2& f2Offset);
...
protected:
	...
	eastengine::math::float2 m_f2Pos;
	eastengine::math::float2 m_f2Size;
...
private:
	...
	{
	public:
		OutputNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		InputNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		ValueFloatNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
			: MaterialNode(pManager, nID, "Float", f2Pos)
			, m_fValue(0.f)
		{
			m_vecOutputSlot.reserve(1);

			CreateOutputSlot("x", MaterialNode::InOutSlot::eFloat, eastengine::math::float2(50.f, 20.f));
		}
	...
	{
	public:
		ValueFloat2Node(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
			: MaterialNode(pManager, nID, "Float2", f2Pos)
		{
			CreateOutputSlot("xy", MaterialNode::InOutSlot::eFloat2, eastengine::math::float2(50.f, 20.f));
			CreateOutputSlot("x", MaterialNode::InOutSlot::eFloat, eastengine::math::float2(50.f, 20.f));
			CreateOutputSlot("y", MaterialNode::InOutSlot::eFloat, eastengine::math::float2(50.f, 20.f));
		}
	...
	private:
		eastengine::math::float2 m_f2Value;
	};

	class FuncAddNode : public MaterialNode
	{
	public:
		FuncAddNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncSubtractNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncMultiplyNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncDivideNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncReciprocalNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncPowerNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncSqrtNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncLogNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncMinNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncMaxNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncAbsNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncSignNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncCeilNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncRoundNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncFloorNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncTruncNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncStepNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncSmoothstepNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncIfNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncFracNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncFmodNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncClampNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncLerpNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncDotNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncCrossNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncReflectNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncNormalizeNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncSinNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncCosNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncTanNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncArcSinNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncArcCosNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncArcTanNode(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
	...
	{
	public:
		FuncArcTan2Node(MaterialNodeManager* pManager, int nID, const eastengine::math::float2& f2Pos)
...
private:
	...
	eastengine::math::float2 m_f2Scrolling;
