...
namespace eastengine
{
	namespace graphics
	{
		...
		PointLight* PointLight::Create(const string::StringID& strName, const math::float3& f3Position, const math::Color& color, float fIntensity, float fAmbientIntensity, float fReflectionIntensity)
		{
