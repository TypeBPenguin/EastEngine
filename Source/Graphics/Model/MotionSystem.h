...
namespace est
{
	namespace graphics
	{
		...
		public:
			virtual void Play(MotionLayers emLayer, const MotionPtr& pMotion, const MotionPlaybackInfo* pMotionState = nullptr) override;
		...
		private:
			...
			std::vector<MotionTransform> m_motionTransforms;
			bool m_isDirtyMotionTransform{ true };
		};
	}
}