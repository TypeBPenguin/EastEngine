	...
	namespace graphics
	{
		namespace dx12
		{
			...
			ID3D12RootSignature* SSS::Impl::CreateRootSignature(ID3D12Device* pDevice)
			{
				...
				{
					util::GetStaticSamplerDesc(SamplerState::eMinMagLinearMipPointClamp, shader::eSampler_LinearPointClamp, 100, D3D12_SHADER_VISIBILITY_PIXEL),
					util::GetStaticSamplerDesc(SamplerState::eMinMagMipPointClamp, shader::eSampler_PointClamp, 100, D3D12_SHADER_VISIBILITY_PIXEL),
				};
