...
namespace Contents
{
	...
	bool Sun::Init(const string::StringID& strName, graphics::ILight* pLight, float fRadius, const math::float3& f3CenterAxis, const math::float3& f3Velocity, const math::float3& f3OrbitalPos)
	{
