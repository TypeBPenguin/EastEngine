...
namespace eastengine
{
	namespace graphics
	{
		...
		public:
			...
			virtual void SetVector(const string::StringID& strName, const math::float2& f2Value) override;
			virtual void SetVector(const string::StringID& strName, const math::float3& f3Value) override;
			virtual void SetVector(const string::StringID& strName, const math::float4& f4Value) override;
			...
			virtual void SetVectorArray(const string::StringID& strName, const math::float2* pf2Value, uint32_t nOffset, uint32_t nCount) override;
			virtual void SetVectorArray(const string::StringID& strName, const math::float3* pf3Value, uint32_t nOffset, uint32_t nCount) override;
			virtual void SetVectorArray(const string::StringID& strName, const math::float4* pf4Value, uint32_t nOffset, uint32_t nCount) override;
		...
		struct EffectVectorVariable : public EffectVariable, public EffectVectorHandle
		{
			...
			virtual void SetVector(const math::float2& f2Value) override;
			virtual void SetVector(const math::float3& f3Value) override;
			virtual void SetVector(const math::float4& f4Value) override;
			...
			virtual void SetVectorArray(const math::float2* pData, uint32_t nOffset, uint32_t nCount) override;
			virtual void SetVectorArray(const math::float3* pData, uint32_t nOffset, uint32_t nCount) override;
			virtual void SetVectorArray(const math::float4* pData, uint32_t nOffset, uint32_t nCount) override;
		};
